...
# Tasks
powerball_task = PythonOperator(task_id="scrape_powerball", python_callable=scrape_powerball, dag=dag)

megamillions_task = PythonOperator(task_id="scrape_megamillions", python_callable=scrape_megamillions, dag=dag)
